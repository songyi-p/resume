        ...
        <GridModal title="# Strength" className="item-d bg-olive-green">
            <div className="w-full h-full p-4 grid grid-rows-3 grid-cols-3 gap-6 md:gap-2">
                ...
                <div className="strength-desc">
                    ...
                    <div>따라서 관계에 있어서는 청자가, 일에 있어서는 화자가 되려하는 편입니다.</div>
                </div>

                <div className="strength-desc items-end">
                    <div>각각의 포인트를 캐치해 하나의 결과물을 만들어내는 것을 잘합니다.</div>
                    <div>완전히 새로운 기술이 탄생되는 시대가 아닌</div>
                    <div>강점을 엮어 새로운 가치를 창출해내는 지금, 꼭 필요한 역량이라고 생각합니다.</div>
                </div>
                <strong className="strength-title">
                    조합 능력
                ...
                <div className="strength-desc">
                    <div>독립적인 성향이지만, 팀 안에선 가치 있는 기여자가 되는 것을 희망합니다.</div>
